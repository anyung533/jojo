...
cp -rf /ql/repo/anyung533_jojo/file/sign_graphics_validate.js /ql/scripts/
cp -rf /ql/repo/anyung533_jojo/file/ql.js /ql/scripts/
cp -rf /ql/repo/anyung533_jojo/file/code.sh /ql/config/
cp -rf /ql/repo/anyung533_jojo/file/task_before.sh /ql/config/
#助力依赖
cp -rf /ql/repo/anyung533_jojo/function /ql/scripts/
