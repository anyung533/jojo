/**
 ...
 cron "12 9,15 1-30 9,10 *" https://raw.githubusercontent.com/anyung533/jojo/main/jd_xinxiangyin.js
 * */
const $ = new Env('古蜀寻宝');
...
!(async () => {
    ...
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/anyung533/jojo/main/file/xinxiangyin.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://raw.githubusercontent.com/anyung533/jojo/main/file/xinxiangyin.json');}catch (e) {}
...
async function main() {
    ...
    if(!$.activityData.opencard){
        if(!$.shareUuid){$.shareUuid = 'a5e8557b614f44efaafd530c2892b0c4';}
        await join($.venderId);
        await $.wait(2000);
        await takePostRequest('activityContent');
        await $.wait(2000);
