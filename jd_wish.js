...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/Aaron-slv/updateTeam/master/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaron-slv/updateTeam@master/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/Aaron-slv/updateTeam@master/shareCodes/wish.json')
  }
